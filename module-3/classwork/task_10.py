str = input("Введите целое число от 0 до 50: ")

numbers = list(map(int, str.split()))

sum_neg = sum(num for num in numbers if num < 0)
...
product_indices_3 = 1
has_product_indices_3 = False
for i in range(0, len(numbers), 3):
    product_indices_3 *= numbers[i]
    has_product_indices_3 = True
if not has_product_indices_3:
    product_indices_3 = 0
